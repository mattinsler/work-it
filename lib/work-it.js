...
exports.Providers = {
  Monitoring: {
    Redis: require('./redis-monitoring-provider')
  },
  Log: {
    Console: require('./console-log-provider'),
    Multi: require('./multi-log-provider'),
  ...
  Queue: {
    ...
    Multi: require('./multi-queue-provider')
  },
...
exports.Providers.Monitoring.get = function(type) { return getProvider(exports.Providers.Monitoring, type); };
...
exports.configure = function(opts) {
  return new exports.Configurer(opts);
};

exports.configureFromFile = function(filename) {
  return exports.Configurer.fromFile(filename);
};
