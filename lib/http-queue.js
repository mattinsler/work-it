...
HttpQueue.prototype.complete = function(message) {
  return this.redisQueue.complete(message);
};

HttpQueue.prototype.fail = function(message) {
  return this.redisQueue.fail(message);
};

HttpQueue.prototype.heartbeat = function(message) {
  return this.redisQueue.heartbeat(message);
};
