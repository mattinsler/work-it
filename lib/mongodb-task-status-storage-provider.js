...
MongodbTaskStatusStorageProvider.prototype.getTaskList = function(command) {
  if (command) {
    return this.model.where({command: command}).array();
  }
  return this.model.array();
};

MongodbTaskStatusStorageProvider.prototype.getTask = function(id) {
